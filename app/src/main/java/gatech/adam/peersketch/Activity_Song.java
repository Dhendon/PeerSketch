...
public class Activity_Song extends Activity
    ...
    private Song current; // Song data
    private Fragment_Navigation_Drawer mFragmentNavigationDrawer; // Navigation drawer fragment
    private Fragment_Navigation_Drawer mSongDrawerFragment; // Editing/toolds drawer fragment
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentNavigationDrawer = (Fragment_Navigation_Drawer)
                getFragmentManager().findFragmentById(R.id.navigation_drawer);

        mSongDrawerFragment = (Fragment_Navigation_Drawer)
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container, CurrentSongFragment.newInstance(position + 1))
                .commit();
    }
    ...
    // Internal classes
        ...
        // Current song list fragment (map, listView of tracks, expandableList of groups)
        // ____________________________________________________________
        public static class CurrentSongFragment extends Fragment {
             ...
             * number.
             */
            public static CurrentSongFragment newInstance(int sectionNumber) {
            ...
            public View onCreateView(LayoutInflater inflater, ViewGroup container,
                ...
                // Root - fragment_song, in CurrentSongActivity
                ...
                // Adapting to expanded list gatech.adam.peersketch.view...
                ExpandableList_Adapter expandableList_adapter = new ExpandableList_Adapter(
                        getActivity(),
                        groups
                );
                ExpandableListView expandableListView =  (ExpandableListView) rootView.findViewById(R.id.groupList_currentSong);
                expandableListView.setAdapter(expandableList_adapter);

                FloatingActionButton fab = (FloatingActionButton) rootView.findViewById(R.id.play_button);
            ...
            public void onAttach(Activity activity) {
                ...
                ((Activity_Song) activity).onSectionAttached(
